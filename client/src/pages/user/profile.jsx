    ...
    try {
      if (isSubscribed) {
        ...
        if (subscription) {
          ...
          await api.post("/unsubscribe", { subscription: subscription, userId: userInfo.id });
        ...
        if (permission === "granted") {
          ...
          await api.post("/subscribe", { subscription: subscription, userId: userInfo.id });
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              ...
              <button onClick={() => setShowAvatarModal(false)} className="p-2 text-gray-400 hover:text-gray-900 hover:bg-gray-100 rounded-full">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Or choose illustration</span>
                <div className="h-px bg-gray-200 flex-1"></div>
              </div>
