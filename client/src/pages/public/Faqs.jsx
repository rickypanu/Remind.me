...
// Upgraded data structure with Telegram notification logic
const faqData = [
  {
    id: 1,
    category: "Notifications",
    question: "How do I get pinged for upcoming tests?",
    answer: "We use Telegram for all our reminders! Just head to the 'Telegram' section in your profile, connect our official bot, and you'll receive automated alerts right to your phone or desktop."
  },
  {
    id: 2,
    category: "Notifications",
    question: "Do I need the web app open to get my reminders?",
    answer: "Not at all. Because we route alerts through Telegram, you'll get pinged instantly as long as you have the Telegram app installed—no need to keep your browser tab running."
  },
  {
    id: 3,
    category: "Tasks",
  ...
  },
  {
    id: 5,
    category: "Tasks",
    question: "What happens if I miss a Telegram alert?",
  ...
  },
  {
    ...
    answer: "Yes! All core task tracking, Telegram notifications, and synchronization features are completely free to use."
  }
];
