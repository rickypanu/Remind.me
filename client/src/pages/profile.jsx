...
import { ArrowLeft, LogOut, Trash2, User as UserIcon, AlertTriangle, Loader2, CalendarDays } from 'lucide-react';
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm mb-6 flex flex-col items-center text-center">
          ...
          {userInfo?.created_at && (
            <div className="flex items-center gap-1.5 mt-4 px-3 py-1.5 bg-gray-50 border border-gray-100 text-gray-500 rounded-full text-sm font-medium">
              ...
              <span>
                Member since {new Date(userInfo.created_at).toLocaleDateString('en-US', { 
                  month: 'long', 
                  year: 'numeric' 
                })}
              </span>
            ...
            {!showDeleteConfirm ? (
              ...
              >
                ...
                <div className="text-left flex-1">
                  ...
                  <span className="text-sm text-red-500/80">Permanently remove all your data</span>
                </div>
              </button>
            ) : (
              <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-red-700">Are you absolutely sure?</h3>
                    <p className="text-sm text-red-600 mt-1">
                      This action cannot be undone. All your reminders and data will be permanently deleted.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    disabled={deleteLoading}
                  >
                    {deleteLoading ? <Loader2 size={18} className="animate-spin" /> : "Yes, Delete My Account"}
                  </button>
                </div>
              </div>
            )}
